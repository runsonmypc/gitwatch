...
- Conventional commit prefixes (`feat:`, `fix:`, `docs:`, `style:`, `refactor:`, `test:`, `chore:`, `perf:`, `ci:`, `build:`, `revert:`, `skill:`, `case:`/`cases:`, `tool:`/`tools:`, `spec:`/`specs:`/`openspec:`/`openspecs:`) become icons
